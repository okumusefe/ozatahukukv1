...
87 articles total: 39 TCK + 48 CMK
"""
import os
import re

# Style characteristics:
# 1. Clear, direct opening
# 2. Semicolon structure in paragraphs
# 3. Concrete examples
# 4. Yargıtay references
# 5. Practical application
# 6. Human-centered conclusion
        ...
        <div class="container">
            <div class="article-card full-article">
                <div class="article-header">
                    ...
                    <span class="article-date">29 Mart 2026</span>
                </div>
                <h2 class="article-title">{h2}</h2>
                
                <div class="article-content">
{body}
                </div>
                
                <div class="article-author"><p><strong>Yazar:</strong><br>Avukat Ege Özata<br>Özata Hukuk Bürosu<br><em>29 Mart 2026</em></p></div>
